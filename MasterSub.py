...
Probs = {1: probs[1], 2: probs[2]} # , 3: probs[3], 4: probs[4]
...
class MasterProb:
    ...
    def AddBendersCut(self, bt, ut, lt, Tm, rm, ubm, lbm):
        ...
        # print(self.eta + quicksum(self.X[x_key] * E[x_key] for x_key in X_keys) >= e)
        self.master.update()
...
class SubProb:
    ...
    def AddSplit(self, y_key, split_sense):
        ...
        self.sub.update()
    def ReturnModel(self):
        return self.sub.copy(), self.T, self.W, self.r, self.ub, self.lb
